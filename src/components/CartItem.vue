...
<template>
  <div class="flex items-center hover:bg-gray-100 mx-1 my-2 h-28 space-x-5 ">
    ...
    <div class="flex h-full w-1/3 lg:w-1/6 p-2">
      <img :src="props.initialItem.image" />
    </div>
    ...
    <div class="flex h-full w-2/3 lg:w-full flex-col justify-between">
      <div class="flex flex-col justify-between">
        ...
        <span class="font-bold text-sm">{{ props.initialItem.name }}</span>
        <!-- </router-link> -->
        <div class="flex space-x-5 lg:justify-start">
          <span class="text-center font-semibold text-xs text-gray-400">R{{ props.initialItem.price }}</span>
      ...
      <div class="flex justify-between pr-5">
        <div class="flex">
          ...
          <span class="text-center w-8">{{ props.initialItem.quantity }}</span>
